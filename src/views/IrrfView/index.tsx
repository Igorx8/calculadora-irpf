...
import { IStateResponse } from "../../store/modules/types"
...
export const IrffView = () => {
    ...
    const storedState = useSelector((state: IStateResponse) => {
    ...
    return (
        <DefaultTemplate>
            ...
            <Tabela tableHeaders={ths} tableFields={tfs} tableData={tds} enableActions={true} route="/employee" />
        </DefaultTemplate>
    )
}